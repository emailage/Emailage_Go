...
// emailPattern contains the regular expression to match an emails address
...
// IsEmail determines that the given email address is valid
func IsEmail(email string) bool {
	return emailPattern.MatchString(email)
}

// IsIP4 determines if the given string is a valid
// IP4 address
...
func IsIPv4(ip string) bool {
	res := net.ParseIP(ip)
	return res != nil && strings.Contains(ip, ".")
}
